    ...
    <div className="bg-[hsl(0,0%,96%)]">
      ...
      <section className="chapter-entete">
        ...
        <div className="chapter-hero">
          ...
          <div className="bg-[hsl(0,0%,96%)] w-full max-w-[75em] mt-4 sm:mt-20 pt-5 px-4 md:px-10 pb-5 flex flex-col justify-start max-h-[22vh] overflow-hidden sm:max-h-none sm:overflow-visible">
